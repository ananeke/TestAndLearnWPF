...
namespace BaseClassesLibrary.AttachedProperties
{
    /// <summary>
    ...
    public abstract class BaseAttachedProperty<Parent,PropertyType> 
        where Parent : BaseAttachedProperty<Parent, PropertyType>, new()
    {
        ...
        /// </summary>
        public static Parent ParentInstance { get; private set; }
        #endregion
        #region Attached Property Definition
        public static readonly DependencyProperty ValueProperty = DependencyProperty.RegisterAttached(
            "Value",
            typeof(PropertyType),
            typeof(BaseAttachedProperty<Parent, PropertyType>),
        ...
        private static void OnValuePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            (ParentInstance as BaseAttachedProperty<Parent, PropertyType>)?.OnValueChanged(d, e);

            // Call event listeners
            (ParentInstance as BaseAttachedProperty<Parent, PropertyType>)?.ValueChanged?.Invoke(d, e);
        }
        ...
        {
            // Call the parent function
            (ParentInstance as BaseAttachedProperty<Parent, PropertyType>)?.OnValueUpdated(d, value);

            // Call event listeners
            (ParentInstance as BaseAttachedProperty<Parent, PropertyType>)?.ValueUpdated?.Invoke(d, value);
